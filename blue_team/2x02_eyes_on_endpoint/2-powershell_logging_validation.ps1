...
.PURPOSE
    purpose : Validate PowerShell Script Block Logging (EID 4104), Module Logging (EID 4103), and partial Session Transcription with full log separation and proactive multi-line transcript generation.
    author: Massimo Rios
.NOTES
