...
try {
    ...
    $criticalEvents = @(
        [PSCustomObject]@{ Id = 4624; Description = "Successful Logon"; Subcategory = "Logon"; Log = "Security" },
        [PSCustomObject]@{ Id = 4625; Description = "Failed Logon"; Subcategory = "Logon"; Log = "Security" },
        [PSCustomObject]@{ Id = 4648; Description = "Explicit Credentials"; Subcategory = "Logon"; Log = "Security" },
        [PSCustomObject]@{ Id = 4688; Description = "Process Creation"; Subcategory = "Process Tracking"; Log = "Security" },
        [PSCustomObject]@{ Id = 4720; Description = "Account Created"; Subcategory = "Account Management"; Log = "Security" },
        [PSCustomObject]@{ Id = 4726; Description = "Account Deleted"; Subcategory = "Account Management"; Log = "Security" },
        [PSCustomObject]@{ Id = 4732; Description = "Member Added to Group"; Subcategory = "Account Management"; Log = "Security" },
        [PSCustomObject]@{ Id = 4672; Description = "Special Logon"; Subcategory = "Special Logon"; Log = "Security" },
        [PSCustomObject]@{ Id = 1102; Description = "Audit Log Cleared"; Subcategory = "System Integrity"; Log = "Security" }
    )
    ...
    foreach ($eventDef in $criticalEvents) {
        ...
        try {
            $events = Get-WinEvent -FilterHashtable @{ LogName = $logName; Id = $eventId; StartTime = $timeThreshold } -ErrorAction Stop
    ...
    # Output formatted telemetry table matching expected output format
    $results | Format-Table -Property "Event ID", "Description", "Audit Subcategory", "Status" -AutoSize
    exit 0
} catch {
    Write-Error "An unexpected error occurred during event log assessment: $_"
    exit 1
}
