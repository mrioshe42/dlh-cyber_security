...
.DESCRIPTION
    ...
    controlled test sequences, verifies event generation, and exports telemetry. Sysmon Operational, PowerShell Operational, Security scheduled task start and stop a service, run a short authorized PowerShell command local user last 30 minutes 
.EXIT CODES
