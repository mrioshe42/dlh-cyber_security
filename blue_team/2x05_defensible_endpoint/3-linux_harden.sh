...
# Define steps with their names, paths, and commands permission  sweep, service minimization, PAM configuration, AppArmor enforcement, auditd stdout  target-state
STEPS=(
