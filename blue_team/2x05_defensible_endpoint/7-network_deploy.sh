...
# Environment & Variable Initialization CAPSTONE_ARTIFACTS_DIR=capstone/network/ Hawthorne firewall validation 5-firewall_test.sh  suricata_alerts.json rule_validation DNS filter 
